  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat, index) => {
          ...
          return (
            <div
              key={index}
              className={`group relative overflow-hidden rounded-2xl bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 p-6 transform transition-all duration-700 hover:scale-105 hover:shadow-2xl cursor-pointer ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className={`bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 transform transition-all duration-1000 hover:shadow-2xl hover:shadow-blue-500/10 ${
        ...
        <div className={`lg:col-span-2 bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 transform transition-all duration-1000 hover:shadow-2xl hover:shadow-cyan-500/10 ${
          animate ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
        }`}>
          <div className="flex items-center justify-between mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className={`bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 transform transition-all duration-1000 hover:shadow-2xl hover:shadow-purple-500/10 ${
          animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}
        ...
        <div className={`bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 transform transition-all duration-1000 hover:shadow-2xl hover:shadow-green-500/10 ${
          animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}
        ...
        <div className={`bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 transform transition-all duration-1000 hover:shadow-2xl hover:shadow-orange-500/10 ${
          animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}
